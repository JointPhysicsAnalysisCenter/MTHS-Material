...
%use postaction and markings to set arrows, use pathmorphing for coil und snake 

%Notice that the tikzpictures below use different subsets of the following commands and definitions.

%%%%%%%%%%%
\newcommand{\myarrow}{\tikz \draw[-Stealth] (0,0);} 
%to quickly draw arrows as nodes in TikZ pictures
%%%%%%%%%%%

%%%%%%%%%%%
%draw momentum arrows as nodes in TikZ pictures:
\newcommand{\momright}[1]{\underset{\rightarrow}{#1}} 
%for example: add right-pointed momentum in draw command via \draw ...node[midway, sloped, above]{$\momright{p}$};  
...
%add vertex (1) at point (0,0) via \vertex{0,0}{1};
